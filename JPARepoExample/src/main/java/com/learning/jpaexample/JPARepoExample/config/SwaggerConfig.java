package com.learning.jpaexample.JPARepoExample.config;
...
public class SwaggerConfig {
	 ...
	 public static final Contact DEFAULT_CONTACT = new Contact(
	  ...
	  public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("SpringBoot JPA Repository Rest API", "Rest API for Book Management",
			  "1.0", "urn:tos",
   ...
   public Docket apiDocket() {
       ...
       Docket docket =  new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.learning.jpaexample.JPARepoExample.controller"))
